...
saveresults = f"{subject}_ann_model_{threshold}results.pkl"
savename = results_path / f"{subject}_ann_model_{threshold}metrics.xlsx"
...
for i in range(len(results)):
    ...
    dd['Number of Layers'] = temp_results[0]
    dd['Nodes per Layer'] = temp_results[1] # architecture
...
df = df.pivot(index = 'Nodes per Layer', columns = 'Number of Layers', values = ['Test AUC', 'Test Loss', 'Val AUC', 'Val Loss'])
